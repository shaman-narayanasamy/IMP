...
// ht_stats
renderStatsCarousel("carousel-mg-raw", "MG/stats", [
...
renderStatsCarousel("carousel-mg-preprocessed", "MG/stats_after_preprocessing", [
    "cycle_composition_2.png",
    "cycle_quality_1.png",
    "cycle_quality_2.png",
    "cycle_quality_box_1.png",
...
renderStatsCarousel("carousel-mt-raw", "MT/stats", [
   "cycle_composition_2.png",
   "cycle_quality_1.png",
   "cycle_quality_2.png",
   "cycle_quality_box_1.png",
...
renderStatsCarousel("carousel-mt-preprocessed", "MT/stats_after_preprocessing", [
    "cycle_composition_2.png",
    "cycle_quality_1.png",
    "cycle_quality_2.png",
    "cycle_quality_box_1.png",
...
renderSimpleCarousel('carousel-assembly', 'MGMT/results', [
    'IMP-vizbin_length.png',
    'IMP-vizbin_length_GC.png'
]);

renderSimpleCarousel('carousel-mapping', 'MGMT/results', [
...
renderSimpleCarousel('carousel-ration', 'MGMT/results', [
    'IMP-vizbin_length_depthRatio.png',
    'IMP-vizbin_length_rpkmRatio.png'
]);

renderSimpleCarousel('carousel-variant', 'MGMT/results', [
    'IMP-var_count.png',
    'IMP-var_density.png',
