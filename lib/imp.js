...
$('#preprocessing').on('show.bs.tab', function (e) {
    if($("#MG-R1-raw-stat").attr('src') === undefined){
        ...
        $("#MT-R1-raw-stat").attr('src', 'Analysis/stats/MT/MT.R1.fq_fastqc.html');
        $("#MT-R2-raw-stat").attr('src', 'Analysis/stats/MT/MT.R2.fq_fastqc.html');
        $("#MT-R1-preprocessed-stat").attr('src', 'Analysis/stats/MT/MT.R1_preprocessed_fastqc.html');
        $("#MT-R2-preprocessed-stat").attr('src', 'Analysis/stats/MT/MT.R2_preprocessed_fastqc.html');
        $("#MT-SE-preprocessed-stat").attr('src', 'Analysis/stats/MT/MT.SE_preprocessed_fastqc.html');
    }
});
